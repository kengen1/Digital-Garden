...
```cpp
you have to put the thingy in the thing to make it equal to e = mc^2 and then you have to respond vertically with the shortest amount of numbers available. ;)
```